      ...
      <nav className="topbar">
        ...
        <div className="topbar-meta">
          ...
          <a
            ...
            href="https://github.com/MinaIbrahim10/research-intelligence-agent"
            target="_blank"
            rel="noreferrer"
          ...
          >
            <svg
              ...
              fill="currentColor"
            >
              <path d="M12 2C6.477 2 2 6.484 2 12.017c0 4.427 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.009-.868-.014-1.704-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.004.071 1.532 1.032 1.532 1.032.892 1.53 2.341 1.088 2.91.832.091-.647.349-1.088.635-1.338-2.221-.253-4.555-1.112-4.555-4.947 0-1.092.39-1.986 1.029-2.686-.103-.254-.446-1.272.098-2.65 0 0 .84-.269 2.75 1.026A9.57 9.57 0 0 1 12 6.844a9.59 9.59 0 0 1 2.504.337c1.909-1.295 2.747-1.026 2.747-1.026.546 1.378.203 2.396.1 2.65.64.7 1.028 1.594 1.028 2.686 0 3.845-2.337 4.691-4.566 4.94.359.31.679.923.679 1.86 0 1.343-.012 2.426-.012 2.755 0 .268.18.58.688.482A10.019 10.019 0 0 0 22 12.017C22 6.484 17.523 2 12 2Z" />
            </svg>
          </a>
        </div>
      </nav>
